...
<main id="primary" class="site-main">
    <section class="bannner">
        ...
        <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/logo.png'; ?> "
            alt="logo Fleurs d'oranger & chats errants" class="logo">
    </section>
        ...
        <article id="place">
            <div>
                <div class="placementnuages">
                    <img src="wp-content\themes\foce-child\assets\images\little_cloud.png" class="nuage nuage1 parallax"
                        alt="nuage1">
                    <img src="wp-content\themes\foce-child\assets\images\big_cloud.png" class="nuage nuage2 parallax"
                        alt="nuage2">
                    <h3>Le Lieu</h3>
                </div>
                <p>
